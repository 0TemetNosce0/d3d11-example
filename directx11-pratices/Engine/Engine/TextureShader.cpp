...
bool TextureShader::Init(HWND hwnd, ID3D11Device* device)
{
...
bool TextureShader::Render(ID3D11DeviceContext* context, int indexCount,
	XMFLOAT4X4 world, XMFLOAT4X4 view, XMFLOAT4X4 proj, ID3D11ShaderResourceView* texture)
{
...
bool TextureShader::InitShader(HWND hwnd, ID3D11Device* device, WCHAR* vsPath, WCHAR* psPath)
{
	HRESULT result;
...
bool TextureShader::SetShaderParameters(ID3D11DeviceContext* context, XMFLOAT4X4 world, XMFLOAT4X4 view, XMFLOAT4X4 proj, ID3D11ShaderResourceView* texture)
{
...
void TextureShader::OutputShaderErrorMessage(HWND hwnd, ID3D10Blob* error, WCHAR* path)
{
